  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-[100] flex shadow-[0_-4px_15px_rgba(0,0,0,0.1)] md:hidden">
        {/* WhatsApp - Left */}
        <a 
          href="https://wa.me/919718344024?text=Hi%2C%20I%20am%20interested%20in%20Purva%20Estrella" 
          target="_blank" 
        ...
        <button 
          onClick={() => setIsOpen(true)} 
          className="flex-1 bg-[#004B87] text-white py-2.5 flex flex-col items-center justify-center gap-1 hover:brightness-105 transition-all"
        >
        ...
        <a 
          ...
          className="flex-1 bg-[#004B87] text-white py-2.5 flex flex-col items-center justify-center gap-1 hover:bg-[#003366] transition-colors"
        >
