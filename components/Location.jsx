...
const locationLandmarks = [
  { name: 'Versova Metro Station (Line 1)', dist: '5 mins' },
  { name: 'DN Nagar Metro Station', dist: '3 mins' },
  { name: 'SV Road', dist: 'On-Site' },
  { name: 'JVLR (Jogeshwari-Vikhroli Link)', dist: '10 mins' },
  { name: 'Andheri Railway Station (W&E)', dist: '10 mins' },
  { name: 'Western Express Highway', dist: '5 mins' },
  { name: 'Link Road', dist: '2 mins' },
  { name: 'Domestic Airport (T1)', dist: '15 mins' },
]
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            >
              ...
              {/* <div className="mt-3 pt-2.5 border-t border-[#edf4e3] flex items-center justify-between text-[11px] text-gray-500 font-medium">
                <span className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-[#004B87] animate-pulse"></span> Prime Lokhandwala Corridor
                </span>
                <span className="text-[#004B87] font-bold">Andheri West</span>
              </div> */}
            </div>
          </div>
          ...
          <div className="w-full lg:flex-1 lg:order-1 flex flex-col justify-center" data-aos="fade-right" data-aos-duration="1000">
            <div style={{
              ...
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.2548409549477!2d72.82219807520694!3d19.140318982077478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b78dcb91ce83%3A0x2275dc0cb4f71432!2sPurva%20Estrella!5e0!3m2!1sen!2sin!4v1788935848060!5m2!1sen!2sin" 
